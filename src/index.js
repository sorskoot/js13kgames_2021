...
(async function () {
    ...
    await import('./classes/lookCamera');
    await import('./classes/blackness');
    await import('./classes/boxController');
    await import('./classes/button');
    await import('./classes/controller');
    await import('./classes/controllers');
    await import('./classes/pcUtils');
    await import('./classes/shape');
    await import('./classes/shapeWorld');    
    await import('./classes/spaceTexture');
    await import('./classes/teleport');
    await import('./classes/teleportCamera');
    await import('./classes/textureAnim');
    await import('./classes/titleText');
    await import('./classes/levelcontroller');
    await import('./classes/game');
